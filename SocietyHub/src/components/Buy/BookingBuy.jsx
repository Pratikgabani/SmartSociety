    ...
    const fetchBookingData = async () => {
      try {
        const response = await axios.post(
          `https://resihub2.onrender.com/api/v1/booking/payBooking/${bookingId}`,
          {},
...
console.log("Payment Info:", paymentInfo);
        await axios.post("https://resihub2.onrender.com/api/v1/booking/save-booking-order", paymentInfo, {
          withCredentials: true,
        });
