...
function Event() {
    ...
    const getUpcomingEvents = async () => {
      try {
        const response = await axios.get(
          "https://resihub2.onrender.com/api/v1/events/getUpcomingEvents",
  ...
  useEffect(() => {
    const fetchPastEvents = async () => {
      try {
        const response = await axios.get(
          "https://resihub2.onrender.com/api/v1/events/getPastEvents",
          { withCredentials: true }
        );
  ...
  useEffect(() => {
    const fetchPaymentStatuses = async () => {
      ...
      for (let event of events) {
        try {
          const response = await axios.get(
            `https://resihub2.onrender.com/api/v1/events/paymentStatus/${event._id}`,
            { withCredentials: true }
          );
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(
        "https://resihub2.onrender.com/api/v1/events/createEvent",
        formData,
        { withCredentials: true }
      );
  ...
  const handleDeleteEvent = async (eventId) => {
    try {
      const response = await axios.delete(
        `https://resihub2.onrender.com/api/v1/events/deleteEvent/${eventId}`,
        { withCredentials: true }
      );
