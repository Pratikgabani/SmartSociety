...
//             ) : (
//               events.map((event) => (
//                 <div key={event._id} className="bg-white rounded-lg shadow-lg p-6 border h-[400px] grid grid-rows-[auto,1fr,auto] gap-4">
...
//                       className={`flex-1 py-2 rounded-lg font-bold text-white ${readyState[event._id]
