...
const PaymentSection = () => {
  ...
  useEffect(() => {
    ...
    const fetchTimeAndDate = async () => {
      try {
        const response = await axios.get("https://resihub2.onrender.com/api/v1/purchase/getAllPurchases", { withCredentials: true });
  ...
  const fetchAgainData = async (a) => {
    ...
    try {
      const response = await axios.get("https://resihub2.onrender.com/api/v1/payment/getAdminData", { withCredentials: true });
      // Update API URL) // Update API URL
  ...
  const deletePayment = async (paymentId) => {
    try {
      await axios.delete(`https://resihub2.onrender.com/api/v1/payment/deletePayment/${paymentId}`, {
        withCredentials: true,
      });
...
const paymentDateLaao = (payId) => {
  ...
  const addPayment = async () => {
    try {
      await axios.post("https://resihub2.onrender.com/api/v1/payment/createPayment", newPayment, {
