        ...
        <div className='px-32 py-6'>
          ...
          <div className='grid md:grid-cols-3 gap-8 mt-5 mb-2 text-black'>
            ...
            <div className='bg-white shadow-xl rounded-xl px-7 py-4'>
              ...
              <p className='text-base my-2 '>Proper management of visitors </p>
            </div>
            <div className='bg-white shadow-xl rounded-xl px-7 py-4'>
      ...
      <div id='benefits' className='pb-12'>
        <div className='px-32 py-6'>
          ...
          <div className='grid md:grid-cols-3 gap-8'>
            ...
            <div className='border-2 px-6 py-2 rounded-xl flex gap-2'>
            ...
            <div className='border-2 px-6 py-2 gap-2 rounded-xl flex items-start'>
              ...
              <form className="space-y-6">
                <div className="grid md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <input type="text" className="w-full bg-white border rounded-lg px-4 py-2 text-gray-600  focus:outline-none" placeholder="Enter first name" />
                  </div>
                  <div>
                    <label className="block text-sm font-medium text-black mb-2">Last Name</label>
                    <input type="text" className="w-full bg-white border rounded-lg px-4 py-2 text-gray-600 foc focus:outline-none" placeholder="Enter last name" />
                  </div>
                </div>
                ...
                <div>
                  ...
                  <input type="text" className="w-full bg-white border rounded-lg px-4 py-2 text-gray-600 foc focus:outline-none" placeholder="Enter society name" />
                </div>

                <div>
                  <label className="block text-sm font-medium text-black mb-2">Message</label>
                  <textarea rows="4" className="w-full bg-white border rounded-lg px-4 py-2 text-gray-600  focus:outline-none" placeholder="Your message..."></textarea>
                </div>
