...
function dashboard() {
  ...
  useEffect(() => {
    const fetchVisitors = async () => {
      try {
        const response = await axios.get("https://resihub2.onrender.com/api/v1/visitor/getActiveVisitorsByUserId", { withCredentials: true });
        setLoading(false);
    ...
    const societyDet = async () => {
      try {
        const response = await axios.get("https://resihub2.onrender.com/api/v1/societyDetail/getSocietyDetail", { withCredentials: true });
        setLoading(false);
    ...
    const fetchComplaints = async () => {
      try {
        const response = await axios.get(`https://resihub2.onrender.com/api/v1/complain/getAllComplains`, { withCredentials: true });
        setLoading(false);
        // console.log(response.data.data)
    ...
    const fetchEvents = async () => {
      try {
        const response = await axios.get(`https://resihub2.onrender.com/api/v1/events/getAllEvent`, { withCredentials: true });
        setLoading(false);
        // console.log(response.data.data)
    ...
    const fetchPolls = async () => {
      try {
        const response = await axios.get(`https://resihub2.onrender.com/api/v1/polls/getAllPolls`, { withCredentials: true });
        setLoading(false);
        // console.log(response.data.data)
    ...
    const fetchBookings = async () => {
      try {
        const response = await axios.get(`https://resihub2.onrender.com/api/v1/booking/getBookingsByUserId`, { withCredentials: true });
        setLoading(false);
        // console.log(response.data.data)
    ...
    const fetchPayments = async () => {
      try {
        const response = await axios.get("https://resihub2.onrender.com/api/v1/payment/getPayments", {
